...
public class room extends javax.swing.JFrame {
    ...
    public void Load_room()
    {
        int c;
        try{
        pst=(PreparedStatement) con.prepareStatement("select * from room");
    ...
    private void initComponents() {
        ...
        txttype.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "AC", "NON/AC" }));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(txttype, 0, 140, Short.MAX_VALUE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            pst = (PreparedStatement) con.prepareStatement("insert into room(rid,rtype,btype,amount) values(?,?,?,?)");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            pst = (PreparedStatement) con.prepareStatement("update room set rtype=?,btype=?,amount=? where rid=?");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            pst = (PreparedStatement) con.prepareStatement("delete from room where rid=?");
            pst.setString(1, roomno);
